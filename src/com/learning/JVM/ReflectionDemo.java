...
public class ReflectionDemo {
	...
	public static void demoClassObjectAccess() {
		...
		System.out.println("Loader "+r.getClass().getClassLoader());
		// Using for Class.forName
		Class clazz = null;
		try {
			clazz = Class.forName("com.learning.JVM.User");
	...
	public static void demoCoreReflection(Class clazz)
		...
		for (Method m : clazz.getDeclaredMethods()) {
			...
			System.out.println("Method name: " + m.getName().startsWith("test") );
	...
	public static void main(String[] args) throws Exception {
		...
		demoCoreReflection(Class.forName("com.learning.JVM.User"));
	}
}
